...
<div class="<?= $c->getPageWrapperClass() ?>">
   ...
   <div class="container-fluid">
      <div class="row">
         ...
         <header class="col-xs-12 text-center dinner-recipes-header">
            <div class="layer"></div>
         ...
         <section class="col-xs-12 col-sm-offset-2 col-sm-8 col-md-offset-2 col-md-8 sortby">
...
<g>
	<path class="st0" d="M44.5,44.9c-1.1-10.8-6.6-19.4-13.7-22.4c3.7-1.9,6.2-5.8,6.2-10.2C37,6,31.9,0.8,25.5,0.8
		...
		c1.2-12.1,8.3-21.3,16.6-21.3S41,32.9,42.2,45.1C42.2,45.7,41.9,46.1,41.7,46.4z"/>
         ...
         <section class="col-xs-12 col-md-offset-1 col-md-10 dinner-recipes">
            <div>
               <div class="col-sm-7">
                  <div>
                     <a href="#">
      ...
      <g>
      	<path class="st0" d="M44.5,44.9c-1.1-10.8-6.6-19.4-13.7-22.4c3.7-1.9,6.2-5.8,6.2-10.2C37,6,31.9,0.8,25.5,0.8
      		...
      		c1.2-12.1,8.3-21.3,16.6-21.3S41,32.9,42.2,45.1C42.2,45.7,41.9,46.1,41.7,46.4z"/>
                           ...
                           <p>2</p>
                           <p>500 cal</p>
                           <img class="pull-right" src="<?php echo $this->getThemePath(); ?>/images/stars.svg" alt="">
                        </div>
                     </a>
                  </div>
               </div>
               <div class="col-sm-5">
                  ...
                  <h4>novice | submitted by <a href="#">jns2000</a></h4>
                  <p>a stew of pumpkin, garlic, and tomatoes.</p>
                  <a href="#">cook this</a>
                  <a href="#">
      	...
      	<path class="st0" d="M44.5,44.9c-1.1-10.8-6.6-19.4-13.7-22.4c3.7-1.9,6.2-5.8,6.2-10.2C37,6,31.9,0.8,25.5,0.8
      		...
      		c1.2-12.1,8.3-21.3,16.6-21.3S41,32.9,42.2,45.1C42.2,45.7,41.9,46.1,41.7,46.4z"/>
               ...
               <div class="col-sm-5">
                  ...
                  <h4>novice | submitted by <a href="#">msrobinson</a></h4>
                  <p>a reimagined dinner roll stuffed with pepperoni, mozarella, and pizza sauce.</p>
                  <a href="pizza-sliders.html">cook this</a>
                  <a href="#">
                  <i class="fa fa-plus" aria-hidden="true"></i>
               </a>
               </div>
      	...
      	<path class="st0" d="M44.5,44.9c-1.1-10.8-6.6-19.4-13.7-22.4c3.7-1.9,6.2-5.8,6.2-10.2C37,6,31.9,0.8,25.5,0.8
      		...
      		c1.2-12.1,8.3-21.3,16.6-21.3S41,32.9,42.2,45.1C42.2,45.7,41.9,46.1,41.7,46.4z"/>
               ...
               <div class="col-sm-5">
                  ...
                  <h4>novice | curated by <a href="#">devour</a></h4>
                  <p>sweet, lemon pepper chicken served with tomatoes and steamed broccoli.</p>
                  <a href="#">cook this</a>
                  <a href="#">
                  <i class="fa fa-plus" aria-hidden="true"></i>
               </a>
      	...
      	<path class="st0" d="M44.5,44.9c-1.1-10.8-6.6-19.4-13.7-22.4c3.7-1.9,6.2-5.8,6.2-10.2C37,6,31.9,0.8,25.5,0.8
      		...
      		c1.2-12.1,8.3-21.3,16.6-21.3S41,32.9,42.2,45.1C42.2,45.7,41.9,46.1,41.7,46.4z"/>
               ...
               <div class="col-sm-5">
                  ...
                  <h4>novice | curated by <a href="#">devour</a></h4>
                  <p>spinach, mushroom, and onion combine in this fresh salad.</p>
                  <a href="#">toss this</a>
                  <a href="#">
                  <i class="fa fa-plus" aria-hidden="true"></i>
               </a>
